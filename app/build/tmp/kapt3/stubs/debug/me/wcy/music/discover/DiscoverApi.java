...
public abstract interface DiscoverApi {
    ...
    long id, @retrofit2.http.Query(value = "tv")
    int tv, @retrofit2.http.Query(value = "lv")
    int lv, @retrofit2.http.Query(value = "rv")
    int rv, @retrofit2.http.Query(value = "kv")
    int kv, @org.jetbrains.annotations.NotNull()
