...
public abstract class Hilt_PhoneLoginFragment extends BaseMusicFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PhoneLoginFragment_GeneratedInjector) this.generatedComponent()).injectPhoneLoginFragment(UnsafeCasts.<PhoneLoginFragment>unsafeCast(this));
    }
  }
