...
public abstract class Hilt_PlaylistTabFragment<T> extends SimpleMusicRefreshFragment<T> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PlaylistTabFragment_GeneratedInjector) this.generatedComponent()).injectPlaylistTabFragment(UnsafeCasts.<PlaylistTabFragment>unsafeCast(this));
    }
  }
