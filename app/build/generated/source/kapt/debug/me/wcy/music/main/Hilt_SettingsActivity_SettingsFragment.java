...
public abstract class Hilt_SettingsActivity_SettingsFragment extends PreferenceFragmentCompat implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SettingsActivity_SettingsFragment_GeneratedInjector) this.generatedComponent()).injectSettingsActivity_SettingsFragment(UnsafeCasts.<SettingsActivity.SettingsFragment>unsafeCast(this));
    }
  }
