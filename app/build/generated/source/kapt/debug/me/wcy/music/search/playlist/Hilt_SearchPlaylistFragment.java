...
public abstract class Hilt_SearchPlaylistFragment<T> extends SimpleMusicRefreshFragment<T> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SearchPlaylistFragment_GeneratedInjector) this.generatedComponent()).injectSearchPlaylistFragment(UnsafeCasts.<SearchPlaylistFragment>unsafeCast(this));
    }
  }
