...
public abstract class Hilt_LocalMusicFragment extends BaseMusicFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((LocalMusicFragment_GeneratedInjector) this.generatedComponent()).injectLocalMusicFragment(UnsafeCasts.<LocalMusicFragment>unsafeCast(this));
    }
  }
