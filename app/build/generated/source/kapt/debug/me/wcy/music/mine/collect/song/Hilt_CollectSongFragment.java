...
public abstract class Hilt_CollectSongFragment extends BaseMusicBottomSheetFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CollectSongFragment_GeneratedInjector) this.generatedComponent()).injectCollectSongFragment(UnsafeCasts.<CollectSongFragment>unsafeCast(this));
    }
  }
