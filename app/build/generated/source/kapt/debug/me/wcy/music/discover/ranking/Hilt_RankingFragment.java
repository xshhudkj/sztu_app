...
public abstract class Hilt_RankingFragment extends BaseMusicFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((RankingFragment_GeneratedInjector) this.generatedComponent()).injectRankingFragment(UnsafeCasts.<RankingFragment>unsafeCast(this));
    }
  }
