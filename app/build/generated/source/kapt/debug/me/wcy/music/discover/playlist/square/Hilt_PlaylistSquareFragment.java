...
public abstract class Hilt_PlaylistSquareFragment extends BaseMusicFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PlaylistSquareFragment_GeneratedInjector) this.generatedComponent()).injectPlaylistSquareFragment(UnsafeCasts.<PlaylistSquareFragment>unsafeCast(this));
    }
  }
