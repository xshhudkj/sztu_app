...
public abstract class Hilt_CurrentPlaylistFragment extends BaseMusicBottomSheetFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CurrentPlaylistFragment_GeneratedInjector) this.generatedComponent()).injectCurrentPlaylistFragment(UnsafeCasts.<CurrentPlaylistFragment>unsafeCast(this));
    }
  }
