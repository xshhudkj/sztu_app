...
public abstract class Hilt_QrcodeLoginFragment extends BaseMusicFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((QrcodeLoginFragment_GeneratedInjector) this.generatedComponent()).injectQrcodeLoginFragment(UnsafeCasts.<QrcodeLoginFragment>unsafeCast(this));
    }
  }
