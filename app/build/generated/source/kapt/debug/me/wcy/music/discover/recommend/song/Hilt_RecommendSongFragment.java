...
public abstract class Hilt_RecommendSongFragment extends BaseMusicFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((RecommendSongFragment_GeneratedInjector) this.generatedComponent()).injectRecommendSongFragment(UnsafeCasts.<RecommendSongFragment>unsafeCast(this));
    }
  }
