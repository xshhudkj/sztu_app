...
public abstract class Hilt_SearchSongFragment<T> extends SimpleMusicRefreshFragment<T> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SearchSongFragment_GeneratedInjector) this.generatedComponent()).injectSearchSongFragment(UnsafeCasts.<SearchSongFragment>unsafeCast(this));
    }
  }
