 ...
 */
class SearchArtistAdapter : ListAdapter<ArtistData, SearchArtistAdapter.ViewHolder>(DiffCallback()) {
    ...
    private class DiffCallback : DiffUtil.ItemCallback<ArtistData>() {
